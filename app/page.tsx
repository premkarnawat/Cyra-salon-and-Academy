...
import type { Banner, Offer, Package, Service, GalleryItem, Review } from "@/types";
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    Promise.allSettled([
      ...
      if (s.status === "fulfilled" && Array.isArray(s.value)) setServices(s.value);
  ...
  return (
    <>
      ...
      {/* Form lock modal */}
      <FormLockModal isOpen={isLocked && !isSubmitted} onSuccess={onFormSuccess} />
